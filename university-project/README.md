...
Консольна програма на Java для управління університетськими даними. Система підтримує облік студентів, викладачів, курсів та процесу зарахування. Дані зберігаються в оперативній пам'яті за допомогою масивів із ручним керуванням розміром. Взаємодія з користувачем здійснюється через інтерфейс консольного меню.
